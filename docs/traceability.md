...
| ARC-003 | Typed REST/OpenAPI contracts and client | `packages/contracts`, `packages/api-client`, `apps/api/src/health.ts`, `apps/api/src/modules/organizations`, `docs/api/openapi.yaml` | `packages/contracts/src/openapi.test.ts`, `packages/contracts/src/organizations.test.ts`, `packages/api-client/src/organizations.test.ts`, `apps/api/src/organizations.test.ts` | P0 · In progress · Phase 1 |
| TEN-001 | Strict Organization isolation | `apps/api/prisma/schema.prisma`, `apps/api/prisma/migrations/20260912220000_organization_creation`, `apps/api/src/modules/organizations/service.ts` | `apps/api/src/organizations.test.ts`, `apps/api/tests/integration/organizations.integration.test.ts`, `tests/e2e/organization-creation.spec.ts` | P0 · In progress · Phase 1 |
...
| AUTH-002 | Verified email gates sensitive actions | `apps/api/src/lib/verification.ts`, `apps/api/src/app.ts`, `apps/api/src/modules/organizations`, `packages/email/src/index.ts` | `apps/api/src/verified-user.test.ts`, `apps/api/src/lib/verification.test.ts`, `apps/api/tests/integration/verification.integration.test.ts`, `apps/api/src/organizations.test.ts`, `apps/api/tests/integration/organizations.integration.test.ts`, `tests/e2e/smoke.spec.ts`, `tests/e2e/organization-creation.spec.ts` | P0 · In progress · Phase 1 |
| RBAC-001 | Multi-role union with Competition assignments | `apps/api/src/app.ts`, `apps/api/src/modules/organizations/service.ts` | `apps/api/src/organizations.test.ts`, `apps/api/tests/integration/organizations.integration.test.ts` | P0 · In progress · Phase 1 |
| ADM-001 | Real User/Organization admin without impersonation | `apps/admin`, `packages/ui/src/app-shell.tsx`, `apps/api/src/app.ts`, `apps/api/src/modules/organizations/service.ts` | `apps/api/src/organizations.test.ts`, `apps/api/tests/integration/organizations.integration.test.ts`, `tests/e2e/organization-creation.spec.ts` | P0 · In progress · Phase 1 |
